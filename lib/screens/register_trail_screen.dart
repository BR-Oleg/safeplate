  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (existing != null) {
        ...
        final tempEstablishmentId = DateTime.now().millisecondsSinceEpoch.toString();
        ...
        final savedId = await FirebaseService.saveEstablishment(newEstablishment);
        targetEstablishment = Establishment(
          ...
          distance: newEstablishment.distance,
          avatarUrl: newEstablishment.avatarUrl,
          difficultyLevel: newEstablishment.difficultyLevel,
          dietaryOptions: newEstablishment.dietaryOptions,
          isOpen: newEstablishment.isOpen,
          ownerId: newEstablishment.ownerId,
          address: newEstablishment.address,
          openingTime: newEstablishment.openingTime,
          closingTime: newEstablishment.closingTime,
          openingDays: newEstablishment.openingDays,
        );

        establishmentProvider.addEstablishment(targetEstablishment);
      }
